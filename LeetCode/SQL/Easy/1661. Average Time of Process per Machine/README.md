# 📝 1661. Average Time of Process per Machine (LeetCode)

🔗 [Problem Link](https://leetcode.com/problems/average-time-of-process-per-machine/?envType=problem-list-v2&envId=m8baczxh)
